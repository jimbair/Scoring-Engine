...
<?
	...
	// Create new tables
	try {
		mysql_query("CREATE TABLE services ( name varchar(10) NOT NULL, teamid int(10) NOT NULL, attempts INT(10) DEFAULT 0, success INT(10) DEFAULT 0, lastcheck INT(1) DEFAULT 0, active INT(1) DEFAULT 0, useauth INT(1) DEFAULT 0, host VARCHAR(30) NOT NULL, user VARCHAR(25), pass VARCHAR(25) )");
